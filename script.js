...
var sFour = 'It is fun';
console.log(sFour.length);
// Challenge 4: Store a string in a variable and convert it into uppercase.
var sFive = 'loving the style of kalvium';
console.log(sFive.toUpperCase());
...
var sSix = 'I love programming';
console.log(sSix.replace(/programming/, 'Javascript programming'));
// Challenge 6: Store a string in variable and print the string in console 3 times using repeat method.
var sSeven = 'Python is easy ';
console.log(sSeven.repeat(3));
...
var sEight = 'I am a Kalvian';
console.log(sEight.split(' '));
...
var sNine = 'Time and Tide wait for none';
console.log(sNine.indexOf('Ti'));
...
var sTen = 'When life gives you lemons make lemonade';
console.log(sTen.includes('lemon'));
...
var sEleven = 'You must be the change you wish to see in the world.';
console.log(sEleven.slice(16, 22));
console.log(sEleven.substring(46, 51));
